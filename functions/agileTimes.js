...
function addTimesheet(intent, session, callback) {
    ...
    if (projectSlot && typeof(projectSlot.value) !== 'undefined') {
        ...
        speechOutput = categorySlot && typeof(categorySlot.value) !== 'undefined' ? `Got it Nikita. Adding new timesheet to ${project} project, ${category} category.` : `Got it Nikita. Adding new timesheet to ${project} project.`;
    } else {
